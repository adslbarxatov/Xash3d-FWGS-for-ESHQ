...
// ESHQ: поддержка управления звуком
#define SF_TRAIN_SMALLRADIUS		0x0010
#define SF_TRAIN_MEDIUMRADIUS		0x0020
#define SF_TRAIN_BIGRADIUS			0x0040
#define SF_TRAIN_LARGERADIUS		0x0080
