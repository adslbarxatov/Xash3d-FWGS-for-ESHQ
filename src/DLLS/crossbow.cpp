...
void CCrossbowBolt::BoltTouch (CBaseEntity* pOther)
	...
	if (pOther->pev->takedamage)
		...
		switch (RANDOM_LONG (0, 1))
			{
			case 0:
				EMIT_SOUND (ENT (pev), CHAN_BODY, "weapons/xbow_hitbod1.wav", 1, ATTN_MEDIUM); break;
			case 1:
				EMIT_SOUND (ENT (pev), CHAN_BODY, "weapons/xbow_hitbod2.wav", 1, ATTN_MEDIUM); break;
			}
...
void CCrossbow::Precache (void)
	...
	PRECACHE_SOUND ("weapons/xbow_reload2.wav");
