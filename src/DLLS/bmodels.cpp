...
class CFuncRotating: public CBaseEntity
	...
	public:
		...
		float m_pitch;
		int	  m_sounds;
		// ESHQ: поле исправляет баг, при котором, если сохранение выполнено во время остановки,
		// при загрузке из сохранения поведение func_rotating меняется на разгон
		int	 isSpinningUpOrRunning;
	};
