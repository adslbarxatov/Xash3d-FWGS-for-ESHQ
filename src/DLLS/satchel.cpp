...
class CSatchelCharge: public CGrenade
	...
	void HLEXPORT SatchelSlide (CBaseEntity* pOther);
	void HLEXPORT SatchelThink (void);
...
void CSatchelCharge::BounceSound (void)
	...
	switch (RANDOM_LONG (0, 2))
		{
		case 0:
			EMIT_SOUND (ENT (pev), CHAN_VOICE, "weapons/g_bounce1.wav", 1, ATTN_MEDIUM);
			break;
		case 1:
			EMIT_SOUND (ENT (pev), CHAN_VOICE, "weapons/g_bounce2.wav", 1, ATTN_MEDIUM);
			break;
		case 2:
			EMIT_SOUND (ENT (pev), CHAN_VOICE, "weapons/g_bounce3.wav", 1, ATTN_MEDIUM);
			break;
		}
	}
