...
void W_Precache (void)
	...
	PRECACHE_SOUND ("weapons/concrete_hit2.wav");
...
void CBasePlayerItem::FallThink (void)
	...
	if (pev->flags & FL_ONGROUND)
		...
		if (!FNullEnt (pev->owner))
			...
			EMIT_SOUND_DYN (ENT (pev), CHAN_VOICE, "items/weapondrop1.wav", 1, ATTN_MEDIUM, 0, pitch);
			}
...
void CBasePlayerItem::DefaultTouch (CBaseEntity* pOther)
	...
	if (pOther->AddPlayerItem (this))
		...
		EMIT_SOUND (ENT (pPlayer->pev), CHAN_ITEM, "items/gunpickup2.wav", 1, ATTN_MEDIUM);
		}
...
int CBasePlayerWeapon::ExtractAmmo (CBasePlayerWeapon* pWeapon)
	...
	if (pszAmmo1 () != NULL)
		...
		// ESHQ: исправление для неисчезающих своевременно пустых MP5
		return iReturn;
		}
...
void CWeaponBox::Touch (CBaseEntity* pOther)
	...
	EMIT_SOUND (pOther->edict (), CHAN_ITEM, "items/gunpickup2.wav", 1, ATTN_MEDIUM);
	SetTouch (NULL);
	UTIL_Remove (this);
	}
