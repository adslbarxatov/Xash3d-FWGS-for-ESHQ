...
int CBaseEntity::Save (CSave& save)
	...
	if (save.WriteEntVars ("ENTVARS", pev))
		return save.WriteFields ("BASE", this, m_SaveData, HLARRAYSIZE (m_SaveData));
...
int CBaseEntity::Restore (CRestore& restore)
	...
	if (status)
		status = restore.ReadFields ("BASE", this, m_SaveData, HLARRAYSIZE (m_SaveData));
...
int	CBaseEntity::Intersects (CBaseEntity* pOther)
	{
	/*
	ESHQ: веро€тно, эта манипул€ци€ больше не потребуетс€
