...
void CGrenade::Explode (TraceResult* pTrace, int bitsDamageType)
	...
	switch (RANDOM_LONG (0, 2))
		{
		case 0:	EMIT_SOUND (ENT (pev), CHAN_VOICE, "weapons/debris1.wav", 0.55, ATTN_MEDIUM);	break;
		case 1:	EMIT_SOUND (ENT (pev), CHAN_VOICE, "weapons/debris2.wav", 0.55, ATTN_MEDIUM);	break;
		case 2:	EMIT_SOUND (ENT (pev), CHAN_VOICE, "weapons/debris3.wav", 0.55, ATTN_MEDIUM);	break;
		}
...
void CGrenade::BounceSound (void)
	...
	switch (RANDOM_LONG (0, 2))
		{
		case 0:	EMIT_SOUND (ENT (pev), CHAN_VOICE, "weapons/grenade_hit1.wav", 0.25, ATTN_MEDIUM);	break;
		case 1:	EMIT_SOUND (ENT (pev), CHAN_VOICE, "weapons/grenade_hit2.wav", 0.25, ATTN_MEDIUM);	break;
		case 2:	EMIT_SOUND (ENT (pev), CHAN_VOICE, "weapons/grenade_hit3.wav", 0.25, ATTN_MEDIUM);	break;
		}
	}
