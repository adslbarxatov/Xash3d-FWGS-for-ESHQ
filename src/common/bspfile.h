...
// [FWGS, 01.03.26] worldcraft predefined angles
/*define ANGLE_UP			-1
define ANGLE_DOWN			-2*/
#define ANGLE_UP	-1
#define ANGLE_DOWN	-2

// [FWGS, 01.03.26] bmodel limits
...
// [FWGS, 01.03.26] lightstyle management
...
// [FWGS, 01.03.26] these limis not using by modelloader but only for displaying 'mapstats' correctly
...
// [FWGS, 01.03.26] quake lump ordering
...
// [FWGS, 01.03.26] extra lump ordering
...
// [FWGS, 01.03.26] Ambient sound types
enum
	{
...
// [FWGS, 01.03.26] leaf 0 is the generic CONTENTS_SOLID leaf, used for all solid areas
...
// [FWGS, 01.03.26] NOTE: that edge 0 is never used, because negative edge nums
