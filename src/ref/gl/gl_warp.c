...
/***
=================
R_AddSkyBoxSurface [FWGS, 01.07.26]
=================
***/
...
void R_DrawSkyBox (void)
	...
	for (int i = 0; i < SKYBOX_MAX_SIDES; i++)
		...
		if (tr.skyboxTextures[r_skyTexOrder[i]])
			...
			GL_Bind (XASH_TEXTURE0, tr.grayTexture);	// stub
...
/***
==============
R_CloudRenderSide [FWGS, 01.07.26]
==============
***/
