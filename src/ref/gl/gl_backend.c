...
/***
==============
GL_BackendEndFrame [FWGS, 01.07.26]
==============
***/
...
/***
==============
GL_CleanUpTextureUnits [FWGS, 01.07.26]
==============
***/
...
/***
==============
GL_PushPolygonOffset [FWGS, 05.04.26]
...
/***
==============
GL_PopPolygonOffset [FWGS, 05.04.26]
...
qboolean VID_CubemapShot (const char *base, uint size, const float *vieworg, qboolean skyshot)
	...
	for (i = 0; i < 6; i++)
		...
		if (flags)
			gEngfuncs.Image_Process (&r_side, 0, 0, flags, 0.0f);
...
/***
================
SCR_TimeRefresh_f [FWGS, 01.07.26]
