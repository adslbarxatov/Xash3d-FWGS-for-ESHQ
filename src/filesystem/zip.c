...
static zip_t *FS_LoadZip (const char *zipfile, int *error)
	...
	// refuse to load empty ZIP archives
	if (header_eocd.total_central_directory_record == 0)
		{
...
/***
===========
FS_PrintInfo_ZIP [FWGS, 01.07.24]
===========
***/
...
/***
===========
FS_AddZip_Fullpath [FWGS, 01.07.26]
===========
***/
