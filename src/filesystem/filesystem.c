...
/*
================
FS_AddGameDirectory [FWGS, 01.04.23]
...
void FS_InitGameInfo (gameinfo_t *GameInfo, const char *gamedir)
	...
	GameInfo->max_edicts = 1024;	// ESHQ: увеличено дл€ ESRM
...
/*
==================
FS_SetCurrentDirectory [FWGS, 01.04.23]
