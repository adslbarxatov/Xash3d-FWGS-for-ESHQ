...
void InitInput (void)
	...
	cl_anglespeedkey = gEngfuncs.pfnRegisterVariable ("cl_anglespeedkey", "0.5", FCVAR_ARCHIVE);	// ESHQ: поддержка флага
	...
	cl_movespeedkey = gEngfuncs.pfnRegisterVariable ("cl_movespeedkey", "0.5", FCVAR_ARCHIVE);	// ESHQ: поддержка флага
