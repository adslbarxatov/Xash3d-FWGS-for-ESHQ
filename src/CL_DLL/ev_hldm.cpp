...
float EV_HLDM_PlayTextureSound (int idx, pmtrace_t* ptr, float* vecSrc, float* vecEnd, int iBulletType)
	...
	switch (chTextureType)
		...
		case CHAR_TEX_GLASS:
		case CHAR_TEX_COMPUTER:	fvol = 0.8; fvolbar = 0.2;
...
void EV_HLDM_GunshotDecalTrace (pmtrace_t* pTrace, char* decalName)
	...
	if (iRand < (0x7fff / 2))// not every bullet makes a sound.
		...
		switch (iRand % 5)
			{
			case 0:
				gEngfuncs.pEventAPI->EV_PlaySound (-1, pTrace->endpos, 0, "weapons/ric1.wav", 1.0, ATTN_MEDIUM, 0, PITCH_NORM);
				break;
			case 1:
				gEngfuncs.pEventAPI->EV_PlaySound (-1, pTrace->endpos, 0, "weapons/ric2.wav", 1.0, ATTN_MEDIUM, 0, PITCH_NORM);
				break;
			case 2:
				gEngfuncs.pEventAPI->EV_PlaySound (-1, pTrace->endpos, 0, "weapons/ric3.wav", 1.0, ATTN_MEDIUM, 0, PITCH_NORM);
				break;
			case 3:
				gEngfuncs.pEventAPI->EV_PlaySound (-1, pTrace->endpos, 0, "weapons/ric4.wav", 1.0, ATTN_MEDIUM, 0, PITCH_NORM);
				break;
			case 4:
				gEngfuncs.pEventAPI->EV_PlaySound (-1, pTrace->endpos, 0, "weapons/ric5.wav", 1.0, ATTN_MEDIUM, 0, PITCH_NORM);
				break;
			}
		}
...
void EV_FireGlock1 (event_args_t* args)
	...
	gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_WEAPON, "weapons/pl_gun3.wav", gEngfuncs.pfnRandomFloat (0.92, 1.0),
		ATTN_MEDIUM, 0, 98 + gEngfuncs.pfnRandomLong (0, 3));
...
void EV_FireShotGunDouble (event_args_t* args)
	...
	gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_WEAPON, "weapons/dbarrel1.wav", gEngfuncs.pfnRandomFloat (0.98, 1.0),
		ATTN_MEDIUM, 0, 85 + gEngfuncs.pfnRandomLong (0, 0x1f));
...
void EV_FireShotGunSingle (event_args_t* args)
	...
	gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_WEAPON, "weapons/sbarrel1.wav", gEngfuncs.pfnRandomFloat (0.95, 1.0),
		ATTN_MEDIUM, 0, 93 + gEngfuncs.pfnRandomLong (0, 0x1f));
...
void EV_FireMP5 (event_args_t* args)
	...
	switch (gEngfuncs.pfnRandomLong (0, 1))
		{
		case 0:
			gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_WEAPON, "weapons/hks1.wav", 1,
				ATTN_MEDIUM, 0, 94 + gEngfuncs.pfnRandomLong (0, 0xf));
			break;
		case 1:
			gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_WEAPON, "weapons/hks2.wav", 1,
				ATTN_MEDIUM, 0, 94 + gEngfuncs.pfnRandomLong (0, 0xf));
			break;
		}
	...
	if (gEngfuncs.GetMaxClients () > 1)
		{
		EV_HLDM_FireBullets (idx, forward, right, up, 1, vecSrc, vecAiming, 8192, BULLET_PLAYER_MP5, 2,
			&tracerCount[idx - 1], args->fparam1, args->fparam2);
		}
	else
		{
...
void EV_FireMP52 (event_args_t* args)
	...
	switch (gEngfuncs.pfnRandomLong (0, 1))
		{
		case 0:
			gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_WEAPON, "weapons/glauncher.wav", 1,
				ATTN_MEDIUM, 0, 94 + gEngfuncs.pfnRandomLong (0, 0xf));
			break;
		case 1:
			gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_WEAPON, "weapons/glauncher2.wav", 1,
				ATTN_MEDIUM, 0, 94 + gEngfuncs.pfnRandomLong (0, 0xf));
			break;
		}
	}
...
void EV_FirePython (event_args_t* args)
	...
	switch (gEngfuncs.pfnRandomLong (0, 1))
		{
		case 0:
			gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_WEAPON, "weapons/357_shot1.wav",
				gEngfuncs.pfnRandomFloat (0.8, 0.9), ATTN_MEDIUM, 0, PITCH_NORM);
			break;
		case 1:
			gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_WEAPON, "weapons/357_shot2.wav",
				gEngfuncs.pfnRandomFloat (0.8, 0.9), ATTN_MEDIUM, 0, PITCH_NORM);
			break;
		}
...
void EV_SpinGauss (event_args_t* args)
	...
	gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_WEAPON, "ambience/pulsemachine.wav",
...
void EV_FireGauss (event_args_t* args)
	...
	gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_WEAPON, "weapons/gauss2.wav", 0.5 + flDamage * (1.0 / 400.0),
		ATTN_MEDIUM, 0, 85 + gEngfuncs.pfnRandomLong (0, 0x1f));
	...
	if (tr.fraction < 1.0)
		...
		if (pe->solid != SOLID_BSP)
			...
			switch (gEngfuncs.pfnRandomLong (0, 1))
				{
				case 0:
					gEngfuncs.pEventAPI->EV_PlaySound (idx, tr.endpos, CHAN_BODY, "weapons/xbow_hitbod1.wav", 1,
						ATTN_MEDIUM, 0, PITCH_NORM); break;
				case 1:
					gEngfuncs.pEventAPI->EV_PlaySound (idx, tr.endpos, CHAN_BODY, "weapons/xbow_hitbod2.wav", 1,
						ATTN_MEDIUM, 0, PITCH_NORM); break;
				}
			}
...
void EV_EgonFire (event_args_t* args)
	...
	if (iStartup)
		...
		if (iFireMode == FIRE_WIDE)
			gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_WEAPON, EGON_SOUND_STARTUP, 0.98, ATTN_MEDIUM, 0, 125);
		else
			gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_WEAPON, EGON_SOUND_STARTUP, 0.9, ATTN_MEDIUM, 0, 100);
		}
	else
		{
		if (iFireMode == FIRE_WIDE)
			gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_STATIC, EGON_SOUND_RUN, 0.98, ATTN_MEDIUM, 0, 125);
		else
...
void EV_EgonStop (event_args_t* args)
	...
	if (args->iparam1)
		gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_WEAPON, EGON_SOUND_OFF, 0.98, ATTN_MEDIUM, 0, 100);
...
void EV_HornetGunFire (event_args_t* args)
	...
	switch (gEngfuncs.pfnRandomLong (0, 2))
		{
		case 0:
			gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_WEAPON, "agrunt/ag_fire1.wav", 1, ATTN_MEDIUM, 0, 100);
			break;
		case 1:
			gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_WEAPON, "agrunt/ag_fire2.wav", 1, ATTN_MEDIUM, 0, 100);
			break;
		case 2:
			gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_WEAPON, "agrunt/ag_fire3.wav", 1, ATTN_MEDIUM, 0, 100);
			break;
		}
	}
// ======================
...
void EV_TrainPitchAdjust (event_args_t* args)
	...
	if (stop)
		...
		{
		gEngfuncs.pEventAPI->EV_PlaySound (idx, origin, CHAN_STATIC, sz, m_flVolume, ATTN_MEDIUM, SND_CHANGE_PITCH, pitch);
		}
	}
