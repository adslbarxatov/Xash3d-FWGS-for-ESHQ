...
unsigned int SV_UpdateFogSettings (unsigned int packed_fog);
...
void SV_ClipMoveToEntity (edict_t *ent, const vec3_t start, vec3_t mins, vec3_t maxs, const vec3_t end,
	trace_t *trace);
