...
static CVAR_DEFINE_AUTO (con_fontscale, "1.0", FCVAR_ARCHIVE,
	"scale font texture");
static CVAR_DEFINE_AUTO (con_fontnum, "-1", FCVAR_ARCHIVE,
	"console font number (0, 1 or 2), -1 for autoselect");
...
static void Con_MessageMode_f (void)
	...
	if (Cmd_Argc () == 2)
		...
		Q_strncpy (con.chat_cmd, "say", sizeof (con.chat_cmd));
...
/***
================
Con_LoadConchars [FWGS, 01.07.26]
================
***/
...
/***
=================
Con_UtfMoveRight [FWGS, 01.07.26]
...
/***
=================
Field_KeyDownEvent [FWGS, 01.07.26]
...
/***
==================
Field_DrawInputLine [FWGS, 01.07.26]
==================
***/
...
/***
===================
Con_HistoryFromField [FWGS, 01.07.25]
===================
***/
...
/***
===================
Con_HistoryToField [FWGS, 01.07.25]
===================
***/
...
void Key_Console (int key)
	...
	if ((key == K_ENTER) || (key == K_KP_ENTER) || (key == K_A_BUTTON))
		...
		// [FWGS, 01.07.24] Just in case, remove all CR and LF characters pushing it to the history.
...
/***
================
Con_DrawDebugLines [FWGS, 01.07.26]
...
/***
================
Con_LastVisibleLine [FWGS, 01.07.26]
...
/***
================
Con_DrawSolidConsole [FWGS, 01.07.26]
...
void Con_DrawVersion (void)
	...
	if (cls.key_dest == key_menu)
		{
		Q_snprintf (curbuild, sizeof (curbuild), "v%i/" XASH_VERSION " (%s-%s build %i)",
			PROTOCOL_VERSION, Q_buildos (), Q_buildarch (), Q_buildnum ());
		}
	else
		{
...
/***
=========
Con_InvalidateFonts [FWGS, 01.07.26]
=========
***/
