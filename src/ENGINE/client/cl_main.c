...
void CL_SignonReply (void)
	...
	Con_Reportf ("%s: %i\n", __func__, cls.signon);	// [FWGS, 01.07.24]
...
/***
=================
CL_ReadNetMessage [FWGS, 01.07.24]
=================
***/
