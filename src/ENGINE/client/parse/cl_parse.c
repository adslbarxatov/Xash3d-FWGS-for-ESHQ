...
/***
==================
CL_ParseViewEntity [FWGS, 05.04.26]
==================
***/
...
// [FWGS, 01.03.26] removed CL_ParseRestoreSoundPacket

/***
==================
CL_ParseSoundPacket [FWGS, 01.07.26]
==================
***/
static void CL_ParseSoundPacket (sizebuf_t *msg, qboolean restore)
	...
	if (FBitSet (flags, SND_ATTENUATION))
		...
		attn = ATTN_EVERYWHERE;	// ESHQ: не уверен, что это Ц правильное решение
...
/***
==================
CL_ParseServerTime [FWGS, 01.07.26]
==================
***/
...
/***
==================
CL_ParseParticles [FWGS, 01.07.26]
==================
***/
...
/***
==================
CL_ParseStaticDecal [FWGS, 01.07.26]
==================
***/
...
/***
==================
CL_ParseSoundFade [FWGS, 05.04.26]
==================
***/
...
/***
==================
CL_RequestMissingResources [FWGS, 01.07.26]
==================
***/
...
/***
==================
CL_ParseCustomization [FWGS, 01.07.26]
==================
***/
static void CL_ParseCustomization (sizebuf_t *msg)
	...
	if (HPAK_GetDataPointer (hpk_custom_file.string, pRes, NULL, NULL))
		...
		if (bError)
			Con_DPrintf ("Error loading customization\n");
		Mem_Free (pRes);
		}
	else
		{
...
/***
==================
CL_SendResourceList [FWGS, 01.07.26]
==================
***/
...
/***
==================
CL_CreateCustomizationList [FWGS, 01.07.26]
...
/***
==================
CL_ParseFileTransferFailed [FWGS, 05.04.26]
==================
***/
...
static void CL_ParseServerData (sizebuf_t *msg, connprotocol_t proto)
	...
	// GoldSrc protocol version is 48, same as Xash3D 48
...
void CL_ParseClientData (sizebuf_t *msg, connprotocol_t proto)
	...
	if (!cls.demoplayback)
		...
		if ((latency >= 0.0f) && (latency <= 2.0f))
			...
			if (latency < cls.latency)
				...
				cls.latency += 0.001f;	// drift up, so corrections are needed
			}
		}
	else
		{
	...
	for (i = 0; i < 64; i++)
		...
		// [FWGS, 01.03.26] read the weapon idx
...
/***
================
CL_ParseLightStyle [FWGS, 01.07.26]
================
***/
...
/***
================
CL_ParseSetAngle [FWGS, 05.04.26]
...
/***
================
CL_ParseAddAngle [FWGS, 01.07.26]
...
/***
================
CL_ParseCrosshairAngle [FWGS, 05.04.26]
...
/***
================
CL_RegisterUserMessage [FWGS, 01.07.26]
...
/***
================
CL_UpdateUserinfo [FWGS, 01.07.26]
...
/***
==============
CL_ParseResource [FWGS, 01.07.26]
...
/***
================
CL_UpdateUserPings [FWGS, 01.07.26]
...
/***
==================
CL_RegisterResources [FWGS, 01.12.24]
...
void CL_RegisterResources (sizebuf_t *msg, connprotocol_t proto)
	...
	if (cl.worldmodel && (cl.maxclients > 0))
		...
		if (!cl.video_prepped && !cl.audio_prepped)
			...
			// [FWGS, 01.03.26] release unused SpriteTextures
...
/***
==============
CL_ParseResourceList [FWGS, 01.07.26]
==============
***/
...
/***
==================
CL_ParseVoiceInit [FWGS, 05.04.26]
==================
***/
...
/***
==================
CL_ParseResLocation [FWGS, 05.04.26]
==================
***/
...
static void CL_ParseDirector (sizebuf_t *msg)
	...
	// [FWGS, 01.07.26] parse user message into buffer
...
/***
==============
CL_ParseScreenFade [FWGS, 01.07.26]
...
/***
==============
CL_ParseCvarValue [FWGS, 05.04.26]
...
void CL_ParseUserMessage (sizebuf_t *msg, int svc_num, connprotocol_t proto)
	...
	// [FWGS, 01.03.26] message with variable sizes receive an actual size as first byte
	if (iSize == -1)
		{
		if (proto == PROTO_GOLDSRC)
	...
	if (clgame.msg[i].func)
		...
		// ESHQ: отключЄн вызов финальных титров по алиасу END3
#endif
		}
	else
		{
...
/***
================
CL_ParseFinaleCutscene [FWGS, 01.07.26]
...
/***
============
CL_ParseCommonMessage [FWGS, 05.04.26]
...
// [FWGS, 05.04.26] removed CL_ParseCommonDLLMessage

/***
============
CL_ParseCommonHLMessage [FWGS, 05.04.26]
...
/***
=====================
CL_ParseServerMessage [FWGS, 01.07.26]
