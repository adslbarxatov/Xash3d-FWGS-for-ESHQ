...
static void Touch_LoadDefaults_f (void)
	...
	for (i = 0; i < g_LastDefaultButton; i++)
		...
		IN_TouchCheckCoords (&x1, &y1, &x2, &y2);
		button = Touch_AddButton (&touch.list_user, g_DefaultButtons[i].name, g_DefaultButtons[i].texturefile,
...
void Touch_Init (void)
	...
	/*Touch_AddDefaultButton ("menu", "touch_default/menu", "escape", 0.000000, 0.833171, 0.080000, 0.984656,
		color, 2, 1, 0);*/
	Touch_AddDefaultButton ("menu", "touch_default/menu", "cancelselect", 0.000000, 0.833171, 0.080000, 0.984656,
		color, 2, 1, 0);
...
void Touch_Draw (void)
	...
	if (touch.state >= state_edit)
		...
		if (touch.edit)
			...
			float	y1 = touch.edit->y1;
			float	x2 = touch.edit->x2;
			float	y2 = touch.edit->y2;
			IN_TouchCheckCoords (&x1, &y1, &x2, &y2);
