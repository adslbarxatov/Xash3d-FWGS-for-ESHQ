...
static int AVI_OpenCodecContext (AVCodecContext **dst_dec_ctx, AVFormatContext *fmt_ctx, enum AVMediaType type,
	qboolean quiet)
	{
	const AVCodec *dec;
...
static dll_info_t libavutil_info =
	{
		...
		.num_fcts = HLARRAYSIZE (libavutil_funcs),
	};
...
static dll_info_t libavformat_info =
	{
		...
		.num_fcts = HLARRAYSIZE (libavformat_funcs),
	};
...
static dll_info_t libavcodec_info =
	{
		...
		.num_fcts = HLARRAYSIZE (libavcodec_funcs),
	};
...
static dll_info_t libswresample_info =
	{
		...
		.num_fcts = HLARRAYSIZE (libswresample_funcs),
	};
...
static dll_info_t libswscale_info =
	{
		...
		.num_fcts = HLARRAYSIZE (libswscale_funcs),
	};
