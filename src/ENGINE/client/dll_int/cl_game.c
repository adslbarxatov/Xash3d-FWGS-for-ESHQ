...
static const dllfunc_t cdll_exports[] =
	...
	// unused callback. Now camera code is completely moved to the user area
...
/***
=============
CL_DrawCenterPrint [FWGS, 01.07.26]
	...
	for (int i = 0; i < clgame.centerPrint.lines; i++)
		...
		for (int j = 0; j < lineLength; j++)
			...
			if ((x >= 0) && (y >= 0) && (x <= refState.width))
				x += CL_DrawCharacter (x, y, line[j], NULL, font, FONT_DRAW_HUD | FONT_DRAW_NORENDERMODE |
					FONT_DRAW_NOCOLOR);
			}
...
/***
=============
CL_DrawScreenFade [FWGS, 01.07.26]
...
/***
====================
CL_ParseTextMessage [FWGS, 01.07.26]
...
/***
====================
CL_SoundFromIndex [FWGS, 01.07.26]
...
/***
================
CL_Scissor [FWGS, 01.07.26]

perform common scissor test
================
***/
qboolean CL_Scissor (const scissor_state_t *scissor, float *x, float *y, float *width, float *height,
...
void CL_InitEdicts (int maxclients)
	...
	if ((clgame.maxRemapInfos - 1) != clgame.maxEntities)
		...
		clgame.remap_info = (remap_info_t **)Mem_Calloc (clgame.mempool, sizeof (remap_info_t *) *
...
/***
==================
CL_ClearSpriteTextures [FWGS, 01.07.26]
...
/***
=============
CL_LoadHudSprite [FWGS, 01.07.26]
...
/***
=============
CL_LoadSpriteModel [FWGS, 01.07.26]
...
/***
=============
CL_GetSpritePointer [FWGS, 01.07.26]
=============
***/
static const model_t *CL_GetSpritePointer (HLSPRITE hSprite)
	{
	/*model_t *mod;*/
	int index = hSprite - 1;
...
/***
=============
pfnGetPlayerInfo [FWGS, 01.07.26]
=============
***/
...
/***
=============
pfnPlaySoundByIndex [FWGS, 01.07.26]
=============
***/
...
=============
***/
static void GAME_EXPORT pfnPlaySound (int ent, float *org, int chan, const char *samp, float vol, float attn,
	int flags, int pitch)
	{
...
/***
=============
CL_FindModelIndex [FWGS, 01.07.26]
=============
***/
...
static void GAME_EXPORT CL_PlayerTrace (float *start, float *end, int traceFlags, int ignore_pe, pmtrace_t *tr)
	...
	*tr = PM_PlayerTraceExt (clgame.pmove, start, end, traceFlags, clgame.pmove->numphysent,
...
=============
***/
static void GAME_EXPORT CL_PlayerTraceExt (float *start, float *end, int traceFlags, int (*pfnIgnore)(physent_t *pe),
	pmtrace_t *tr)
	{
	if (!tr)
		return;
	...
	*tr = PM_PlayerTraceExt (clgame.pmove, start, end, traceFlags, clgame.pmove->numphysent,
		clgame.pmove->physents, -1, pfnIgnore);
	}
...
/***
=============
pfnLoadMapSprite [FWGS, 01.07.26]
=============
***/
...
/***
=============
PlayerInfo_SetValueForKey [FWGS, 01.07.26]
=============
***/
...
=============
***/
static void GAME_EXPORT pfnSPR_DrawGeneric (int frame, int x, int y, const wrect_t *prc, int blendsrc,
	int blenddst, int width, int height)
	{
...
/***
=============
pfnDrawStringReverse [FWGS, 01.07.26]
=============
***/
...
/***
=============
TriSpriteTexture [FWGS, 01.07.26]
...
static cl_enginefunc_t gEngfuncs =
	...
	pfnGetGameDirectory,
	/*pfnCVarGetPointer,*/
	CL_CvarGetPointer,	// [FWGS, 01.07.26]
	Key_LookupBinding,
	pfnGetLevelName,
	pfnGetScreenFade,
	pfnSetScreenFade,
...
qboolean CL_LoadProgs (const char *name)
	...
	for (int i = 0; i < HLARRAYSIZE (cdll_exports); i++)
		{
	...
	for (int i = 0; i < HLARRAYSIZE (cdll_new_exports); i++)
		{
