...
// [FWGS, 01.12.24] should be 48, only to differentiate it from PROTOCOL_LEGACY_VERSION
#define PROTOCOL_GOLDSRC_VERSION_DEMO (PROTOCOL_GOLDSRC_VERSION | (BIT( 7 )))
...
/***
====================
CL_GetDemoFramerate [FWGS, 01.12.24]
...
/***
====================
CL_WriteDemoCmdHeader [FWGS, 01.07.26]
...
/***
=================
CL_DrawDemoRecording [FWGS, 01.07.26]
=================
***/
...
/***
=================
CL_DemoReadMessageQuake [FWGS, 01.07.26]
...
/***
==============
CL_DemoInterpolateAngles [FWGS, 01.07.26]
...
/***
==============
CL_FinishTimeDemo [FWGS, 01.09.24]
...
void CL_StopPlayback (void)
	...
	if (cls.changedemo)
		...
		{
		// [FWGS, 01.03.26] let game known about demo state
...
/***
==================
CL_GetDemoComment [FWGS, 01.07.26]
==================
***/
...
// [FWGS, 01.09.24]
static qboolean CL_ParseDemoHeader (const char *callee, const char *filename, file_t *f, demoheader_t *hdr,
	int32_t *numentries)
	{
