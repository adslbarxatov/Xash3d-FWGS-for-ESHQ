...
static void SDLash_KeyEvent (SDL_KeyboardEvent key)
	...
	// ESHQ: отключено, т.к. мешает установке текстовых клавиш в меню настройки управлени€
	if (0 && host.textmode && down)
		{
