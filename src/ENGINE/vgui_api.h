...
typedef struct  vguiapi_s
	...
	// translates 2D drawing for the everything that's not VGUI, used to simulate GoldSrc
	// behavior which installs matrix in push/popMakeCurrent
	void	(*SetPaintOffset)(int x, int y); 
	} vguiapi_t;
